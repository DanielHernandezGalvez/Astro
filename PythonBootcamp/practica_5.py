...
# ========== Reto 5 Juego ahorcado =============

from random import choice

palabras = ["perro", "panadero", "tiburon", "jiroscopio"]
letras_correctas = []
letras_incorrectas = []
intentos = 6
aciertos = 0
...
def mostras_nuevo_tablero(palabra_elegida):
...
def ganar(palabra_descubierta):
    mostras_nuevo_tablero(palabra_descubierta)
